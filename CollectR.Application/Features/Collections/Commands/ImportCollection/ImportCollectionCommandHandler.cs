...
internal sealed class ImportCollectionCommandHandler(IImportService importService) : ICommandHandler<ImportCollectionCommand, Result<Unit>>
{
    public async Task<Result<Unit>> Handle(ImportCollectionCommand request, CancellationToken cancellationToken)
    {
